...
Public Class IncluirCompra
    ...
    Private Sub IncluirCompra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            ...
            ElseIf TextBox2.Text.length > 8 Then
                MessageBox.Show("Valor inserido muito alto!", "Valor inválido", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            ElseIf convert.ToInt64(TextBox2.Text) + convert.ToInt64(TextBox1.Text) > 999999999 Then
                MessageBox.Show("O valor máximo de saldo não pode ultrapassar 999999999!", "Valor de saldo muit alto", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Else
                saldo = (Convert.ToInt64(TextBox2.Text) + saldo)
                TextBox1.Text = saldo
                Try
                    ...
                    fluxoTexto.Close()
                    fluxoTexto.Dispose()
                    MessageBox.Show("Itens adicionados com sucesso!", "Pronto", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    adicionarelatorio()
                Catch ex As Exception
        ...
        Try
            If File.Exists(arquivorel) Then
                Using sw As StreamWriter = File.AppendText(arquivorel)
                    ...
                    sw.WriteLine("in- " & TextBox2.Text & "          " & TextBox3.Text)
                    sw.Close()
            ...
            Else
                ...
                Using sw2 As New StreamWriter(arquivorel)
                    ...
                    sw2.WriteLine("in- " & TextBox2.Text & "          " & TextBox3.Text)
                    sw2.Close()
                End Using
